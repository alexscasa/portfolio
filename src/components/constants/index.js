...
export const PROJECT_NOTES = [
    ...
    'This project was developed using BabylonJS, a javascript 3D game engine.  I developed this game to get a feel for 3D game development in a familiar language.  There is an issue with the collision detection and it has yet to be solved.  I plan to incorporate multiplayer features and an unsupervised learning algorithm after fixing the collision detection.  A long term goal is to integrate VR support with the goal to create a unique atmosphere to play chess in VR against opponents, or the AI, in a variety of environments through the use of 360 video.'
];
